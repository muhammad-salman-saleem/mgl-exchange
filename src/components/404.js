    ...
    return (
        <section className="bg-white dark:bg-gray-900 ">
            <div className="container min-h-screen px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12">
                ...
                <div className="relative w-full mt-8 lg:w-1/2 lg:mt-0 justify-center items-center flex">
                    <img className="w-1/2 lg:h-[50%] h-[50%] md:h-[50%] rounded-lg object-cover" src="/favicon.png" alt="" />
                </div>
